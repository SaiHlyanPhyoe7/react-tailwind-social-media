    ...
    return (
        <div className='grid grid-cols-12 py-1'>
            <div className='col-span-4 flex items-center justify-start my-1'>
                <div className=''>
                    <img className='w-[45px] rounded-full ml-5' src={img1} alt=""/>
                </div>
                <div className='flex items-center gap-0'>
                    ...
                    <input type="search" placeholder='Search ...'
                           className='focus:border-none px-1 py-1 h-[100% my-auto] bg-white border-none outline-none rounded-r-full'/>
                </div>
            </div>
